            ...
            <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="mailto:contact@startify.tn" className="text-teal-600 hover:text-teal-700">
                        contact@startify.tn
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="mailto:support@startify.tn" className="text-teal-600 hover:text-teal-700">
                        support@startify.tn
                      </a>
                    </div>
                  </div>
              ...
              <div className="glass rounded-3xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full px-8 py-4 bg-gradient-to-r from-teal-600 to-emerald-600 text-white rounded-xl text-lg font-semibold hover:shadow-2xl hover:scale-105 transition-all"
                  >
                    Send Message
                  </button>
                </form>
